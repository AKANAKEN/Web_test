...
<div class="w3-top">
    <div class="w3-bar w3-black w3-card" id="myNavbar">
      <a href="index.php" class="w3-bar-item w3-button w3-wide">Pemberi Tau Empire</a>
      <!-- Right-sided navbar links -->
      <div class="w3-right w3-hide-small">
        <a href="index.php" class="w3-bar-item w3-button"> Pemberitahuan </a>
        <a href="staff.php" class="w3-bar-item w3-button"><i class="fa fa-user"></i> TEAM </a>
        ...
        <a href="donation.php" class="w3-bar-item w3-button"><i class="fa fa-usd"></i> DONATION </a>
        <button onclick="myFunction1()" href="aktivity.php" class="w3-bar-item w3-button"><i class="fa fa-desktop"></i> Aktivity </button>
        <a href="contact.php" class="w3-bar-item w3-button"><i class="fa fa-envelope"></i> Link </a>
      </div>
